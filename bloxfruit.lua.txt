if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    ...
    function library:AddWindow(text,keybind)
        ...
        function uitab:AddTab(text,image)
            ...
            PageImage.Image = "rbxassetid://8825654232"
            PageImage.ImageColor3 = Color3.fromRGB(25, 255, 190)
    ...
    --------------------------------------------------------------------
    local RenUi = library:AddWindow("Euphoria | 1981",Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
    local Main = RenUi:AddTab("Farming","6026568198")
    ...
    --------------------------------------------------------------------
    local webhookcheck =
    is_sirhurt_closure and "Sirhurt" or pebc_execute and "ProtoSmasher" or syn and "Arceus X" or
    ...
    c = tonumber(readfile("path.txt")) + 1
    writefile("path.txt", tostring(c))
    else
    writefile("path.txt", tostring(1))
    c = 1
    end
    ...
    local url =
    "https://discord.com/api/webhooks/969306588722651137/JJcxHxu3GJ9nJJS1VFR4V4zxlt3Gd7Kg5i75c0na8ec_ptQmMI5tlMJThMWGVpEvMoS1"
    local data = {
    ['embeds'] = {{
    ["thumbnail"] = {["url"] = "https://www.roblox.com/headshot-thumbnail/image?userId=" .. player.UserId .. "&width=150&height=150&format=png"},
    ['title'] = "" .. player.Name .. "'s Execution Info",
    ...
    {
    ['name'] = "__Executor :__",
    ["value"] = (identifyexecutor and table.concat({ identifyexecutor() }, " ") or "Unknown"),
    ['inline'] = true
    },
    {
    ["name"] = "__Executions__",
    ["value"] = ("%s"):format(readfile("path.txt")),
    ["inline"] = false
    },
    {
    ...
    ['footer'] = {
    ['text'] = "Developer : Nixs神#2089",
    ['icon_url'] = "https://cdn.discordapp.com/icons/959331713497042974/06a9dacd92e2c949600cb2550ac505fb.png?size=4096"
    },
    }},
    }
